        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative my-5 h-5/6 w-11/12 max-w-5xl transform rounded-lg bg-white p-6 text-left shadow-xl transition-all">
                  ...
                  <div className="relative flex h-[85vh] w-full justify-center">
                    <Image
                      src={src}
                      alt={alt}
                      fill={true}
